    ...
    public partial class FormSeznam : Form
    {
        ...
        **/
        ...
        private void ZobrazChybuSpousteni(string chyba)
        {
            ...
            DialogResult odpoved = Actions.Show.Question("Spuštění programu", MessageBoxButtons.RetryCancel, "Program se nepodařilo spustit.", chyba, "Kliknutím na tlačítko 'Znovu' se program spustí znovu.");
        ...
        **/
        ...
        private void menuNastaveniYoutubeDLCestaZmenit_Click(object sender, EventArgs e)
        {
            ...
            if (vyberSouboru.ShowDialog() == DialogResult.OK)
            {
                ...
                MenuCestaZobrazit(2);
                ZobrazitOperaci("Cesta programu YouTube-DL úspěšně změněna: '" + Files.ProgramYouTubeDl + "'");
            }
        }
        ...
        private void menuNastaveniFFmpegCestaZmenit_Click(object sender, EventArgs e)
        {
            ...
            if (vyberSouboru.ShowDialog() == DialogResult.OK)
            {
                ...
                MenuCestaZobrazit(3);
                ZobrazitOperaci("Cesta programu FFmpeg úspěšně změněna: '" + Files.ProgramFfmpeg + "'");
            }
        }
        ...
        private void menuNastaveniMp3tagCestaZmenit_Click(object sender, EventArgs e)
        {
            ...
            if (vyberSouboru.ShowDialog() == DialogResult.OK)
            {
                ...
                MenuCestaZobrazit(4);
                ZobrazitOperaci("Cesta programu mp3tag úspěšně změněna: '" + Files.ProgramMp3tag + "'");
            }
        }
        ...
        **/
        ...
        private void MenuCestaNactiZeSouboru(int typ)
        {
            ...
            if (typ == 0) cestaSouboru = Files.LibraryOpusHistory;
            else if (typ == 1) cestaSouboru = Files.LibraryMp3History;
            else if (typ == 2) cestaSouboru = Files.ProgramYouTubeDlHistory;
            else if (typ == 3) cestaSouboru = Files.ProgramFfmpegHistory;
            else if (typ == 4) cestaSouboru = Files.ProgramMp3tagHistory;
            else { return; }
            ...
            {
                if (typ == 0) Directories.LibraryOpus = pridejCesty.First().Trim();
                else if (typ == 1) Directories.LibraryMp3 = pridejCesty.First().Trim();
                MenuCestaZobrazit(typ);
            }
            else if (File.Exists(pridejCesty.First().Trim()))
            {
                if (typ == 2) Files.ProgramYouTubeDl = pridejCesty.First().Trim();
                else if (typ == 3) Files.ProgramFfmpeg = pridejCesty.First().Trim();
                else if (typ == 4) Files.ProgramMp3tag = pridejCesty.First().Trim();
                MenuCestaZobrazit(typ);
            }
        }
        ...
        **/
        ...
        private void backgroundWorkerProhledejSlozky_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                ZobrazitOperaci("Hudební knihovna '" + Directories.LibraryOpus + "' byla úspěšně prohledána.");
                ZobrazitStav();
            }
        ...
        **/
        ...
        {
            if (!Actions.Run.Program("https://youtube.com/channel/" + App.YouTube.User.ID, false))
            {
                // TODO show error
            }
        }
